Feature: Check checkout functionality as guest user
  ...
  Scenario Outline: Make Checkout as guest user with samples
    ...
    Examples:
      |userlogin        |userpassword|id           |id2          |promocode|       email     |firstName|lastName|streetNumber|addressName|city              |postCode|state|phoneNumber|ccName|ccNumber|month|year|cvv|
      |ogboiko@gmail.com|ogboiko123  | WW-40710YSL | WW-20655YSL |test|ogboiko@gmail.com|   Ole   |  Boyko |16u         |Mahony Rd  |Constitution Hill |2145    |NSW   |0999999999|My cc name|4111111111111111|April|2019|737|
