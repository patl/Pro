Feature: Check create account functionality
  ...
  Scenario Outline:  Create account B2B other professional
...
And click on validate button for B2B
    ...
    Examples:
      ...
      |Frau       |Ole      |Boiko   |21  |11   |1991|strasse 7|andere Fachkraft, außer Haar und Schönheit|Deutschland |111111125|sometext|strasse 3|