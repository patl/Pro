Feature: Check create account functionality
  ...
  Scenario Outline:  Create account B2B Salone employee
    ...
    Then user uploads document <docpath> the proof section B2B Salon employee
    ...
    Examples:
      |greeting   |firstname|lastname|date|month|year|address  |ownew                                |docpath    |address2 |
      |Frau       |Ole      |Boiko   |21  |11   |1991|strasse 7|Angestellte(r) eines Salons/Instituts|C:\\asd.png|strasse 3|