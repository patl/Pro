Feature: Check create account functionality
  ...
  Scenario Outline:  Create account B2B home hairdresser
    ...
    Examples:
      ...
      |Frau       |Ole      |Boiko   |21  |11   |1991|strasse 7|Friseur in Heimarbeit|Deutschland |111111125|sometext|strasse 3|